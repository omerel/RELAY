...
public interface BLConstants {
    ...
    int TIME_RELAY_SEARCH_INTERVAL = 45*SECOND;//60
    int TIME_RELAY_SEARCH_INTERVAL_POWER_MODE = 45*SECOND;//60
    int TIME_RELAY_SCAN = 5*SECOND;//
    int TIME_RELAY_KEEPS_FOUND_DEVICE_IN_LIST = 60*SECOND;//20
    int TIME_RELAY_KEEPS_FOUND_DEVICE_IN_LIST_POWER_MODE = 60*SECOND;//20
