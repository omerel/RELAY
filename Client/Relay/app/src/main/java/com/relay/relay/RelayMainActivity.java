...
public class RelayMainActivity extends AppCompatActivity implements View.OnClickListener {

    private final String TAG = "RELAY_DEBUG: "+ RelayMainActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.relay_activity_main);
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action){
                    ...
                    case MESSAGE_RECEIVED:
                        ...
                        mArrayAdapter.add(RelayMainActivity.this.setResult(relayMessage));
